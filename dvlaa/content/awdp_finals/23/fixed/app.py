...
# FIXED(AWDP23): object-level visibility checks restored.

        # FIXED(AWDP23): preview enforces visibility and tenant scoping.
        if document["visibility"] != "public" or document["tenant_id"] != caller_tenant:
