...
class ChallengeBase(ABC):
    ...
    def get_help_content(self) -> dict:
        ...
        return {
            ...
            "background": cfg.get("background", "") if cfg else "",
            "normal_flow": cfg.get("normal_flow", "") if cfg else "",
            "protected_assets": cfg.get("protected_assets", "") if cfg else "",
            "audit_focus": cfg.get("audit_focus", "") if cfg else "",
            "repair_focus": cfg.get("repair_focus", "") if cfg else "",
            "investigation_steps": list(cfg.get("investigation_steps", [])) if cfg else [],
        }
